...
namespace WorldCities.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<ActionResult> Import()
        {
            ...
            //define howmany rows we want to process
            ...
            //create a lookup dictionary containing already existing into the Database (will be empty on first run)
            ...
            //iterates through all rows, skipping first one
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                var row = worksheet.Cells[nRow, 1, nRow, worksheet.Dimension.End.Column];
                ...
                //create the city and fill with xlsx data
                var city = new City
                {
                    Name = name,
        ...
        public async Task<ActionResult> CreateDefaultUsers()
        {
            ...
            {
                //create a new standard user already exists
